...
if(isset($_POST['submit'])){
	...
	$thoigianxuly = isset($_POST['thoigianxuly']) ? convert_date_dd_mm_yyyy($_POST['thoigianxuly']) : '';
	$phongxuly = isset($_POST['phongxuly']) ? $_POST['phongxuly'] : '';
	...
	$congvan->thoigianxuly = $thoigianxuly ? new MongoDate($thoigianxuly) : '';
	$congvan->phongxuly = $phongxuly;
...
<div class="grid">
	...
	<div class="row cells12">
		...
		<div class="cell colspan2 input-control input">
			<input type="text" name="socongvan" id="socongvan" placeholder="Số công văn" />
		</div>
		<div class="cell colspan2 padding-top-10 align-right">Số thứ tự</div>
		<div class="cell colspan2 input-control input">
			<input type="text" name="sothutu" id="sothutu" placeholder="Số thứ tự" />
		</div>
		<div class="cell colspan2 padding-top-10 align-right">Ngày đi/ngày đến</div>
    ...
    <div class="cell colspan2 padding-top-10">Người ký</div>
		<div class="cell colspan4 align-left input-control text">
			<input type="text" name="nguoiky" id="nguoiky" placeholder="Người ký" value=""/>
    </div>
	</div>
	<div class="row cells12">
		<div class="cell colspan2 padding-top-10">Thời gian xử lý</div>
		<div class="cell colspan4 input-control text" data-role="datepicker" data-format="dd/mm/yyyy">
			<input type="text" name="thoigianxuly" id=thoigianxuly placeholder="Thời gian xử lý" data-inputmask="'alias': 'date'" class="ngaythangnam"/>
			<button class="button"><span class="mif-calendar"></span></button>
		</div>
		<div class="cell colspan2 padding-top-10">Phòng xử lý</div>
		<div class="cell colspan4 input-control text">
			<input type="text" name="phongxuly" id="phongxuly" placeholder="Phòng xử lý" />
		</div>
	</div>
	<div class="row cells12">
