...
<div class="grid">
    ...
    <div class="cell colspan2 padding-top-10">Người ký</div>
		<div class="cell colspan4 align-left input-control text">
			<input type="text" name="nguoiky" id="nguoiky" placeholder="Người ký" value="<?php echo isset($nguoiky) ? $nguoiky : ''; ?>"/>
    </div>
	</div>
	<div class="row cells12">
		...
		<div class="cell colspan4 input-control text" data-role="datepicker" data-format="dd/mm/yyyy">
			<input type="text" name="thoigianxuly" id=thoigianxuly placeholder="Thời gian xử lý" data-inputmask="'alias': 'date'" class="ngaythangnam" value="<?php echo isset($thoigianxuly) ? $thoigianxuly : ''; ?>"/>
			<button class="button"><span class="mif-calendar"></span></button>
		</div>
		<div class="cell colspan2 padding-top-10">Phòng xử lý</div>
		<div class="cell colspan4 input-control text">
			<input type="text" name="phongxuly" id="phongxuly" placeholder="Phòng xử lý" value="<?php echo isset($phongxuly) ? $phongxuly : ''; ?>"/>
		</div>
	</div>
	<div class="row cells12">
